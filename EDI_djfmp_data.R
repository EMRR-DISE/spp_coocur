...
# purpose: download Delta Juv Fish Monitoring Program data from EDI
# requires:
# modified:

# DJFMP data from EDI ----
# Interagency Ecological Program (IEP), J. Speegle, R. McKenzie, A. Nanninga, E. Holcombe, J. Stagg, J. Hagen, E. Huber, G. Steinhart, and A. Arrambide. 2022. Interagency Ecological Program: Over four decades of juvenile fish monitoring data from the San Francisco Estuary, collected by the Delta Juvenile Fish Monitoring Program, 1976-2022 ver 11. Environmental Data Initiative. https://doi.org/10.6073/pasta/57b6c257edd72691702f9731d5fe4172 (Accessed 2023-03-28).
...
rm(infile1, infile2, infile3, infile4, infile5, inUrl1, inUrl2, inUrl3, inUrl4, inUrl5)

saveRDS(dt1, file = "data/dt1.rds") # 1976-2001_DJFMP_trawl_fish_and_water_quality_data.csv
saveRDS(dt2, file = "data/dt2.rds") # 2002-2022_DJFMP_trawl_fish_and_water_quality_data.csv
saveRDS(dt3, file = "data/dt3.rds") # 1976-2022_DJFMP_beach_seine_fish_and_water_quality_data.csv
saveRDS(dt4, file = "data/dt4.rds") # DJFMP_Fish_Taxonomy.csv
saveRDS(dt5, file = "data/dt5.rds") # DJFMP_Site_Locations.csv